...
(function () {
  ...
  function onSubmit(ev) {
    ...
    CTX.createSession({
      ...
      if (CTX.getState().sessionId &&
        ...
        window.KOZHA_CONTRIB_CHAT.showError({ kind: 'describe', prose: description, gloss: gloss });
  ...
  function loadLanguages() {
    return fetch(LANGUAGES_URL, { headers: { 'Accept': 'application/json' }, cache: 'no-store' })
      .then(function (r) {
